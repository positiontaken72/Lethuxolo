        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="flex flex-col space-y-8 max-w-2xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-4">
              <Button
                size="lg"
                className="bg-[#F2B705] hover:bg-[#d9a304] text-[#111111] rounded-[10px] px-8 h-14 text-base font-bold shadow-none w-full sm:w-auto"
              ...
              <a
                href="#profile"
                className="inline-flex items-center text-[#111111] font-semibold hover:text-[#F2B705] transition-colors text-base group"
          ...
          <div className="relative animate-in fade-in slide-in-from-right-8 duration-1000 delay-200">
            ...
            {/* Floating badge */}
            <div
              className="absolute -bottom-6 -left-6 md:bottom-8 md:-left-12 bg-[#F2B705] rounded-xl shadow-lg p-4 flex items-center gap-4"
